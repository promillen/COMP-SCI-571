[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11857027&assignment_repo_type=AssignmentRepo)
...
1. Interactive map showing location
2. Visual journey showing evolution of the bakery since its opening
3. Real time update of prices when ordering. Maybe a box showing visually the different things you are ordering
4. A pop up of todays feature
5. A language select button. Maybe use AI to translate the site
6. A possibility to customize order. Build your own cake. 

![sketch](figures/annoted_sketch.jpg)
