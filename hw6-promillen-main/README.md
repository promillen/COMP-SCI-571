...
The colors and contrast of the website makes it easy for most people to see what is on the screen. However it could be done more thoroughly.

2. Tolerance for Error:
You can't do anything wrong on the website unless you are logged in, and the website gives back clear alerts about wether the API calls/the action the user wanted went through.
To make it more bulletproof I could have implemented an "are you sure?" prompt box before deleting a post.

B:
Simple and Intuitive Use:
I might have violated this rule, by hiding all elements you are not allowed to, unless you are loged in. I might not be as intuitive for everyone.

Perceptible information:
The color contrast is good, but many other things could be improved on the site regarding to this rule; font-size, more instructions and buttons/cards that stands more out.
...
![universal design principles attempt](_figures/answer.png)
If picture isn't shown, find in _figures folder.
